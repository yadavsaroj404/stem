...
export default function PartialCompletionModal({
  ...
  return (
    <div className="z-20 fixed grid place-items-center bg-black/40 inset-0 w-screen h-screen p-4">
      <div className="w-full max-w-xl text-center border-2 border-[#00A600] rounded-2xl relative bg-[#00A600]/56 pt-10 pb-6 px-6 sm:px-12">
        <Image
          width={150}
          height={150}
          src={clap}
          alt="Clapping Hands"
          unoptimized
          className="w-20 absolute -top-0 left-1/2 transform -translate-1/2"
        />
